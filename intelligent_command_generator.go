...
// CommandPattern represents learned command patterns
type CommandPattern struct {
	...
	OptimizedVersions  []string          `json:"optimized_versions"`
	RiskLevel          string            `json:"risk_level"`
	LastUsed           time.Time         `json:"last_used"`
	Confidence         float64           `json:"confidence"`
}

// OptimizationRule represents a command optimization rule
