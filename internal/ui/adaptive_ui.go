...
func NewAdaptiveUIManager(streamingManager *engine.StreamingIntelligenceManager) *AdaptiveUIManager {
...
func InitializeAdaptiveUI(streamingManager *engine.StreamingIntelligenceManager) {
